...
public class CreateInvertedConfig {

  public static void main(String[] args) throws IOException {
    if (args.length != 2) {
      System.err.println("Usage: CreateInvertedConfig <input path> <output path>");
      System.exit(-1);
    }
String stopWords="a,able,about,above,abst,accordance,according,accordingly,across,act,actually,a"
		+"dded,adj,adopted,affected,affecting,affects,after,afterwards,again,against,ah,all,almost"
		+",alone,along,already,also,although,always,am,among,amongst,an,and,announce,"
		...
		+"besides,between,beyond,biol,both,brief,briefly,but,by,c,ca,came,can,cannot,"
		...
		+"done,don't,down,downwards,due,during,e,each,ed,edu,effect,eg,eight,eighty,"
		+"either,else,elsewhere,end,ending,enough,especially,et,et-al,etc,even,ever,every,"
		+"everybody,everyone,everything,everywhere,ex,except,f,far,few,ff,fifth,first,five,"
		+"fix,followed,following,follows,for,former,formerly,forth,found,four,from,further,"
		+"furthermore,g,gave,get,gets,getting,give,given,gives,giving,go,goes,gone,got,"
		+"gotten,h,had,happens,hardly,has,hasn't,have,haven't,having,he,hed,hence,her,"
		+"here,hereafter,hereby,herein,heres,hereupon,hers,herself,hes,hi,hid,him,himself,"
		+"his,hither,home,how,howbeit,however,hundred,i,id,ie,if,i'll,im,immediate,"
		+"immediately,importance,important,in,inc,indeed,index,information,instead,into,invention,"
		+"inward,is,isn't,it,itd,it'll,its,itself,i've,j,just,k,keep,keeps,kept,keys,"
		+"kg,km,know,known,knows,l,largely,last,lately,later,latter,latterly,least,less,lest,"
		+"let,lets,like,liked,likely,line,little,'ll,look,looking,looks,ltd,m,made,"
		+"mainly,make,makes,many,may,maybe,me,mean,means,meantime,meanwhile,merely,mg,"
		+"might,million,miss,ml,more,moreover,most,mostly,mr,mrs,much,mug,must,my,myself,"
		+"n,na,name,namely,nay,nd,near,nearly,necessarily,necessary,need,needs,neither,"
		...
		+"otherwise,ought,our,ours,ourselves,out,outside,over,overall,owing,own,p,page,pages,"
		+"part,particular,particularly,past,per,perhaps,placed,please,plus,poorly,possible,"
		+"possibly,potentially,pp,predominantly,present,previously,primarily,probably,promptly,proud,"
		...
		+"resulted,resulting,results,right,run,s,said,same,saw,say,saying,says,sec,section,"
		+"see,seeing,seem,seemed,seeming,seems,seen,self,selves,sent,seven,several,shall,"
		+"she,shed,she'll,shes,should,shouldn't,show,showed,shown,showns,shows,significant,"
		...
		+"specify,specifying,state,states,still,stop,strongly,sub,substantially,successfully,such,"
		+"sufficiently,suggest,sup,sure,t,take,taken,taking,tell,tends,th,than,thank,thanks,"
		...
		+"vs,w,want,wants,was,wasn't,way,we,wed,welcome,we'll,went,were,weren't,we've,"
		...
		+"won't,words,world,would,wouldn't,www,x,y,yes,yet,you,youd,you'll,your,youre,"
		+"yours,yourself,yourselves,you've,z,zero";
    JobConf conf = new JobConf(new Configuration(),CreateInvertedConfig.class);
    conf.setJobName("Create Inverted Index");

    FileInputFormat.setInputPaths(conf, new Path(args[0]));
    FileOutputFormat.setOutputPath(conf, new Path(args[1]));
    
    conf.setMapperClass(CreateInvertedMapper.class);
    conf.setReducerClass(CreateInvertedReducer.class);
